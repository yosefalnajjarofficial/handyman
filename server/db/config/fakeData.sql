...
VALUES (2,1,'build the house','2019-09-24T07:40:20.942Z',15,'pending','build my house','omar el mukhtar','123','12');

INSERT INTO jobs (client_id,handyman_id,description,dead_line,price,status,message,street,building_number,flat_number) 
VALUES (2,1,'build the flat','2019-09-24T07:40:20.942Z',15,'accepted','build the flat','omar el mukhtar','12','142');

INSERT INTO jobs (client_id,handyman_id,description,dead_line,price,status,message,street,building_number,flat_number) 
VALUES (2,1,'build the flat','2019-09-24T07:40:20.942Z',20,'decliend','build the room','omar el mukhtar','132','1422');
