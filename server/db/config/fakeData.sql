...
INSERT INTO handyman (handyman_id, job_id,hour_rate,description) 
VALUES (1,1,15,'good builder');

INSERT INTO jobs (client_id,handyman_id,description,deadline,price,status,message,street,building_number,flat_number) 
